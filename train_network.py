...
from keras.optimizers import SGD #schotastic gradient desecnt : Optimizer for deep neural net --> SGD gives a constant learning rate
from sklearn.model_selection import train_test_split #randomly split the dataset into training and testing 
from keras.preprocessing.image import img_to_array #Convert the image to array
from keras.utils import to_categorical #Converts a class vector (integers) to binary class matrix.
from pyimagesearch.lenet import LeNet #Used for making the CNN models
